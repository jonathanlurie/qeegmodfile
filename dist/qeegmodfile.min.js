...
c.prototype.getMeasureNames=function(){return this._qeegModObj.metadata.informationList[0].labels};c.prototype.getDurationsLabels=function(){return this._qeegModObj.metadata.informationList[1].labels};c.prototype.getFirstSpaceNames=function(){return this._qeegModObj.metadata.informationList[2].labels};c.prototype.getSecondSpaceNames=function(){return this._qeegModObj.metadata.informationList[3].labels};c.prototype.getUnitsLabels=function(){return this._qeegModObj.metadata.informationList[5].labels};
...
value:this._qeegModObj.metadata.informationList[7].values[a]}};c.prototype.getAllContexts=function(){var a=this._qeegModObj.metadata.informationList[7];if(a.labels.length!=a.values.length)return console.warn("The contexts is corrupted. Inequal amount of values/labels."),null;for(var d=[],b=0;b<a.labels.length;b++)d.push({label:a.labels[b],value:a.values[b]});return d};c.prototype.getStartFrequency=function(){return"COR"===this._typeCode?-1:this._qeegModObj.metadata.informationList[7].values[0]};c.prototype.getFrequencyResolution=
function(){return"COR"===this._typeCode?-1:this._qeegModObj.metadata.informationList[7].values[1]};c.prototype.getScaleFactor=function(){var a=2;"COR"===this._typeCode&&(a-=2);return this._qeegModObj.metadata.informationList[7].values[a]};c.prototype.getScaleIfScaleMeasures=function(){var a=3;"COR"===this._typeCode&&(a-=2);return this._qeegModObj.metadata.informationList[7].values[a]};c.prototype.getMeasureName=function(){var a=4;"COR"===this._typeCode&&(a-=2);return this._qeegModObj.metadata.informationList[7].values[a]};
c.prototype.getDurationName=function(){var a=5;"COR"===this._typeCode&&(a-=2);return this._qeegModObj.metadata.informationList[7].values[a]};c.prototype.getFirstSpaceName=function(){var a=6;"COR"===this._typeCode&&(a-=2);return this._qeegModObj.metadata.informationList[7].values[a]};c.prototype.getSecondSpaceName=function(){var a=7;"COR"===this._typeCode&&(a-=2);return this._qeegModObj.metadata.informationList[7].values[a]};c.prototype.getAllDimensionsNames=function(){return[this.getMeasureName(),
this.getDurationName(),this.getFirstSpaceName(),this.getSecondSpaceName()]};c.prototype.getValue=function(a,d,b,c){var f=this._qeegModObj.metadata.sizes;if(0>a||a>=f.measure)return console.warn("measureIndex is out of range."),null;if(0>d||d>=f.duration)return console.warn("durationIndex is out of range."),null;if(0>b||b>=f.firstSpace)return console.warn("firstSpaceIndex is out of range."),null;if(0>c||c>=f.secondSpace)return console.warn("secondSpaceIndex is out of range."),null;a=this._getOffset(a,
d,b,c);return this._qeegModObj.data[a]};c.prototype.getSpectrum=function(a,d,b){a=void 0===a?-1:a;d=void 0===d?-1:d;b=void 0===b?-1:b;var c=this._qeegModObj.metadata.sizes,f=this._qeegModObj.data;return-1==a&&-1==d&&-1==b?f.slice():0<=a&&a<c.measure&&-1==d&&-1==b?(c=this._getOffset(a,0,0,0),a=this._getOffset(a+1,0,0,0),f.slice(c,a)):0<=a&&a<c.measure&&0<=d&&d<c.duration&&-1==b?(c=this._getOffset(a,d,0,0),a=this._getOffset(a,d+1,0,0),f.slice(c,a)):0<=a&&a<c.measure&&0<=d&&d<c.duration&&0<=b&&b<c.firstSpace?
(c=this._getOffset(a,d,b,0),a=this._getOffset(a,d,b+1,0),f.slice(c,a)):null};c.prototype.getSpectrumByLabels=function(a,d,b){a=void 0===a?null:a;d=void 0===d?null:d;b=void 0===b?null:b;var c=this._qeegModObj.metadata.informationList,f=c[0].labels.indexOf(a),e=c[1].labels.indexOf(d),c=c[2].labels.indexOf(b);return a&&-1==f?(console.warn("The measure label "+a+" could not be found."),null):d&&-1==e?(console.warn("The duration label "+d+" could not be found."),null):b&&-1==c?(console.warn("The first-space label "+
b+" could not be found."),null):this.getSpectrum(f,e,c)};c.prototype.getSpectrumLabelsByLabels=function(a,b,c){a=void 0===a?null:a;b=void 0===b?null:b;c=void 0===c?null:c;var d=this._qeegModObj.metadata.informationList,f=d[0].labels.indexOf(a),e=d[1].labels.indexOf(b),d=d[2].labels.indexOf(c);return a&&-1==f?(console.warn("The measure label "+a+" could not be found."),null):b&&-1==e?(console.warn("The duration label "+b+" could not be found."),null):c&&-1==d?(console.warn("The first-space label "+
c+" could not be found."),null):this.getSpectrumLabels(f,e,d)};c.prototype.getSpectrumLabels=function(a,b,c){a=void 0===a?-1:a;b=void 0===b?-1:b;c=void 0===c?-1:c;var d=this._qeegModObj.metadata.sizes,f=this._qeegModObj.metadata.informationList,e=[];return-1==a&&-1==b&&-1==c?(f[0].labels&&e.push(f[0].labels.slice()),f[1].labels&&e.push(f[1].labels.slice()),f[2].labels&&e.push(f[2].labels.slice()),f[3].labels&&e.push(f[3].labels.slice()),e):0<=a&&a<d.measure&&-1==b&&-1==c?(this._getOffset(a,0,0,0),
this._getOffset(a+1,0,0,0),f[0].labels&&f[0].labels.length>a&&e.push(f[0].labels[a]),f[1].labels&&e.push(f[1].labels.slice()),f[2].labels&&e.push(f[2].labels.slice()),f[3].labels&&e.push(f[3].labels.slice()),e):0<=a&&a<d.measure&&0<=b&&b<d.duration&&-1==c?(this._getOffset(a,b,0,0),this._getOffset(a,b+1,0,0),f[0].labels&&f[0].labels.length>a&&e.push(f[0].labels[a]),f[1].labels&&f[1].labels.length>b&&e.push(f[1].labels[b]),f[2].labels&&e.push(f[2].labels.slice()),f[3].labels&&e.push(f[3].labels.slice()),
e):0<=a&&a<d.measure&&0<=b&&b<d.duration&&0<=c&&c<d.firstSpace?(this._getOffset(a,b,c,0),this._getOffset(a,b,c+1,0),f[0].labels&&f[0].labels.length>a&&e.push(f[0].labels[a]),f[1].labels&&f[1].labels.length>b&&e.push(f[1].labels[b]),f[2].labels&&f[2].labels.length>c&&e.push(f[2].labels[c]),f[3].labels&&e.push(f[3].labels.slice()),e):null};c.prototype._getOffset=function(a,b,c,e){var d=this._qeegModObj.metadata.sizes;return(a*d.duration*d.firstSpace+b*d.firstSpace+c)*d.secondSpace+e};b.QeegModFileParser=
e;b.QeegModFileInterpreter=c;Object.defineProperty(b,"__esModule",{value:!0})});
